...
abstract class Page
{
    ...
    {
        $this->_database = new mysqli("localhost", "pizzaService", "wert", "pizzaService");
        /* to do: create instance of class MySQLi */;
     ...
     * @param $script $script is the javascript file to be used for the page
     * @return none
     */
