...
/**
 * Class NavigationBlock for the exercises of the EWA lecture
...
class NavigationBlock        // to do: change name of class
{
    // --- ATTRIBUTES ---
    ...
    public function generateView($id = "")
    {
        ...
        echo "<nav class=\"nav\">
        <ul class=\"nav-list\">
        <li class=\"nav-item\"><a href=\"bakery.html\">Bäckerei</a>
        <li class=\"nav-item\"><a href=\"logistic.html\">Logistik</a>
        <li class=\"nav-item\"><a href=\"shop.html\">Shop</a>
        <li class=\"nav-item\"><a href=\"info.html\">Info</a>
        </ul>
        </nav>";
        echo "</div>\n";
    }
